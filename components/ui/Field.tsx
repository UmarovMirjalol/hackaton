...
const field =
  "w-full rounded-[var(--radius-md)] border border-border bg-surface px-3 text-[13.5px] text-primary outline-none transition-[border-color,box-shadow] duration-150 placeholder:text-tertiary focus:border-primary focus:shadow-[0_0_0_3px_var(--accent-subtle)]";
